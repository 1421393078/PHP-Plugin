...
{
	if (confirm('所有相關的分類與產品皆會刪除! 確定要刪除嗎?'))
		goto('index.php?fn=category1&mo=delete&parent=<?php
echo $_obj['parent'];
?>
&level=<?php
echo $_obj['level'];
...
?>
 + 1;
	go('index.php?fn=category1&parent=' + id + '&level=' + l);
}

function move(id, rank, up)
{
	go('index.php?fn=category1&mo=move&parent=<?php
echo $_obj['parent'];
?>
&level=<?php
echo $_obj['level'];
...
?>
 :</strong></font></td>
              	<td align="right" nowrap  height="18"><!-- InstanceBeginEditable name="Func" --><?php
if ($_stack[0]['level'] == "2"){
?><a href="javascript:go('/admin/index.php?fn=category1&parent=0&level=1');">回到上層</a>&nbsp;&nbsp;<?php
}
?><?php
if ($_stack[0]['level'] != "3"){
...
?>	
              ...
              <tr> 
                <td colspan="2" background="../images/admin/tr1.gif"><img src="../images/admin/spacer.gif" width="1" height="1"></td>
							...
							<tr><td colspan="2"><br><!-- InstanceBeginEditable name="Other2" --><table width="100%"><tr><td>目錄結構: <?php
if (!empty($_obj['path'])){
...
$_obj=&$path;
?><a href="index.php?fn=category1&parent=<?php
echo $_obj['id'];
?>
&level=<?php
echo $_obj['level'];
...
?><table cellpadding="0" cellspacing="0" height="300" width="100%"><tr><td valign="top" align="center">
                  <!-- InstanceBeginEditable name="Content" -->
						<table border="0" cellpadding="3" cellspacing="1" class="table" width="100%">
							<tr class="header"><td width="20">#</td>
							
							<td width="300">分類名稱</td>
							<td width="200">功能</td>
							</tr>
									<?php
...
?>
<tr>
	<td colspan="4" align="center" bgcolor="#FFFFFF"><font color="#0000FF">無資料!</font></td>
	</tr>
<?php
} else {
?>
...
echo $_obj['ROWBIT'];
?>
(this, false);"><td align="right" nowrap><?php
echo $_obj['i'];
?>
</td>
...
<td align="center" nowrap>
	<?php
if ($_stack[0]['level'] != "2"){
?><button type="button" class="button" onClick="view2(<?php
echo $_obj['id'];
?>
);">檢視子分類</button>&nbsp;<?php
}
?>
	<button type="button" onClick="edit(<?php
echo $_obj['id'];
?>
);" class="button" <?php
...
echo $_stack[0]['NODELETE'];
?>
>刪除</button>&nbsp;
	<button type="button" class="button" onClick="move(<?php
echo $_obj['id'];
?>
, <?php
echo $_obj['rank'];
?>
, 1);">上移</button>&nbsp;<button type="button" class="button" onClick="move(<?php
echo $_obj['id'];
?>
, <?php
echo $_obj['rank'];
