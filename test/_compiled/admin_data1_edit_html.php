...
<script language="javascript">
function confirmDeletePicture2()
{
	if (confirm('確定要刪除此圖片嗎?'))
		go('<?php
echo $_obj['EDIT_URL'];
...
function confirmDeletePicture3()
{
	if (confirm('確定要刪除此圖片嗎?'))
		go('<?php
echo $_obj['EDIT_URL'];
...
function confirmDeletePicture4()
{
	if (confirm('確定要刪除此圖片嗎?'))
		go('<?php
echo $_obj['EDIT_URL'];
...
function confirmDeletePictureg()
{
	if (confirm('確定要刪除此圖片嗎?'))
		go('<?php
echo $_obj['EDIT_URL'];
...
function promoClick()
{
	...
	if (frm.promo.checked)
		x.style.display = '';
	else
		x.style.display = 'none';
}
function infoClick( objSelf, im_serial )
{
	if ( objSelf.checked)
		document.getElementById( 'span' + im_serial ).style.display = '';
	else
		document.getElementById( 'span' + im_serial ).style.display = 'none';
}
</script>
<!-- InstanceEndEditable -->
</head>
...
?>
 :</strong></font></td>
              	<td align="right" nowrap  height="18"><!-- InstanceBeginEditable name="Func" --><span class="selected">編輯產品資料</span> | <a href="javascript:goback();">回到列表</a><!-- InstanceEndEditable --></td>
              </tr>
              <tr>
              	<td colspan="2">
<?php
...
<tr>
	...
	<td class="field"><input type="checkbox" name="newin" value="1">新進商品</td>
</tr>
<tr>
	<td class="left">Item No.</td>
	<td class="field"><input type="text" name="item_no" size="82" maxlength="32" value="<?php
echo $_obj['item_no'];
?>
"></td>
</tr>
...
echo $_obj['spec1_name'];
?>
</td>
	<td class="field"><textarea name="spec1" rows="4" style="width:100%"><?php
echo $_obj['spec1'];
?>
</textarea></td>
</tr>
...
echo $_obj['spec2_name'];
?>
</td>
	<td class="field"><input type="text" name="spec2" size="82" maxlength="32" value="<?php
echo $_obj['spec2'];
?>
"></td>
</tr>
<tr>
	<td class="left"><?php
echo $_obj['spec3_name'];
?>
</td>
	<td class="field"><input type="text" name="spec3" size="82" maxlength="32" value="<?php
echo $_obj['spec3'];
?>
"></td>
</tr>
<tr>
	<td class="left"><?php
echo $_obj['spec4_name'];
?>
</td>
	<td class="field"><input type="text" name="spec4" size="82" maxlength="32" value="<?php
echo $_obj['spec4'];
?>
"></td>
</tr>
<tr>
	<td class="left"><?php
echo $_obj['spec5_name'];
?>
</td>
	<td class="field"><input type="text" name="spec5" size="82" maxlength="32" value="<?php
echo $_obj['spec5'];
?>
"></td>
</tr>
<tr>
  <td class="left">圖片</td>
  <td class="field"><?php
if (!empty($_obj['picture'])){
?><img src="img.php?f=<?php
echo $_obj['thumb'];
?>
" border="0"><br>覆蓋原圖:<?php
}
?><input type="file" name="picture" size="30">&nbsp;&nbsp;建議尺寸 110 x 110</td>
</tr>
<tr>
  <td class="left">詳細規格</td>
  <td class="field">檔案上傳:<input type="file" name="file" size="30">&nbsp;&nbsp;( 檔案名稱請用英文 )</td>
</tr>
</table>
<br><button type="submit" class="button" <?php
echo $_stack[0]['NOEDIT'];
?>
>確定更新</button>
</form>
