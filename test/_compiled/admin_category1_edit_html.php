...
?>
 :</strong></font></td>
              	<td align="right" nowrap  height="18"><!-- InstanceBeginEditable name="Func" --><span class="selected">編輯分類</span> | <a href="javascript:goback();">回到列表</a><!-- InstanceEndEditable --></td>
              </tr>
              <tr>
              	<td colspan="2">
<?php
...
?>
" style="margin:0 0 0 0;" enctype="multipart/form-data">
...
<tr>
	<td nowrap class="left">分類名稱</td>
	<td bgcolor="#FFFFFF" class="field"><input type="text" name="name" size="48" maxlength="32"  value="<?php
echo $_obj['name'];
?>
"></td>
</tr>
...
?><input type="file" name="picture" size="30">&nbsp;&nbsp;建議尺寸 146 x 120</td>
</tr>
<?php
}
?>
<tr>
	<td class="left">狀態設定</td>
	<td class="field"><input type="checkbox" name="hide" value="0">上架</td>
</tr>
<tr>

</table>
						<br>
						<button type="submit" class="button">確定編輯</button>
						</form><!-- InstanceEndEditable --></td></tr></table>
                  <p>&nbsp;</p>
