...
echo $_obj['UPDATE_URL'];
?>
" style="margin:0 0 0 0;">
									<table width="185" height="225" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td align="center" valign="middle" background="/images/admin/bg_pass.gif">
...
?>
											...
											<tr>
												...
												<td><input type="password" name="password3" size="12"></td>
											</tr>
										</table>
                  	<br>
										<button type="submit" class="button">確定變更</button>
										</td>
                    </tr>
                  </table>
                 	</form>
